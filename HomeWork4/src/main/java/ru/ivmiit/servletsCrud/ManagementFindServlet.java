...
@WebServlet("/find")
public class ManagementFindServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getServletContext().getRequestDispatcher("/jsp/find.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(usersDao.isExistName(name)) {
            ...
            req.setAttribute("usersFromServerFind", user);
            req.getServletContext().getRequestDispatcher("/jsp/find.jsp").forward(req, resp);
        }
        else {
            String message = "A user with this name does not exist!";
            req.setAttribute("messageFindServlet", message);
            req.getServletContext().getRequestDispatcher("/jsp/find.jsp").forward(req, resp);
        }
    }
}
